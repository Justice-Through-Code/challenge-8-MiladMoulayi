...
# books_with_details is a list of dictionaries. The dictionaries are nested within the list. I know this because each element of the list contains curly braces ({}) around it, while the entire list is enclosed by square brackets ([])
